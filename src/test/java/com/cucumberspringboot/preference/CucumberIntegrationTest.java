...
@CucumberOptions(
        features = "src/test/resources/features/preference/",
        glue = {"com.cucumberspringboot.preference.stepDefinitions",
                "com.cucumberspringboot.preference.configuration"},
        dryRun = false,
        plugin = {"pretty", "html:target/preference/cucumber-html-report.html",
                "json:target/preference/cucumber.json",
                "rerun:target/preference/cucumber-api-rerun.txt"
        })
